    ...
    getBuiltInOptions() {
        ...
        const builtInFlags = [
            ...
            },
            {
                ...
                multiple: false,
                description: "Sets process.env.NODE_ENV to the specified value for access within the configuration.(Deprecated: Use '--config-node-env' instead)",
                helpLevel: "minimum",
            },
            {
        ...
        const options = builtInFlags.concat(Object.entries(this.webpack.cli.getArguments()).map(([name, meta]) => {
            return Object.assign(Object.assign({}, meta), { name, description: meta.description, group: "core", helpLevel: minimumHelpFlags.includes(name) ? "minimum" : "verbose" });
        }));
        ...
        const callback = (error, stats) => {
            ...
            if (options.json && createStringifyChunked) {
                ...
                if (options.json === true) {
                    Readable.from(createStringifyChunked(stats.toJson(statsOptions)))
